...
/* harmony import */ var _modules_imgFullScreen__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/imgFullScreen */ "./src/js/modules/imgFullScreen.js");
...
new wow_js__WEBPACK_IMPORTED_MODULE_7___default.a().init(); //Указ, что все события пудут происходить после полной загрузки HTML

window.addEventListener('DOMContentLoaded', function () {
  'use strict';

  var modalState = {};
  var deadline = '2022-06-16';
  ...
  Object(_modules_imgFullScreen__WEBPACK_IMPORTED_MODULE_6__["default"])();
});
...
var changeModalState = function changeModalState(state) {
  ...
  function bidnActionToEl(e, elem, prop) {
  ...
  ;
  bidnActionToEl('click', windowForm, 'form');
  bidnActionToEl('input', windowHeight, 'height');
  bidnActionToEl('input', windowWidth, 'width');
  bidnActionToEl('change', windowType, 'type');
  bidnActionToEl('change', windowProfile, 'profile');
};
